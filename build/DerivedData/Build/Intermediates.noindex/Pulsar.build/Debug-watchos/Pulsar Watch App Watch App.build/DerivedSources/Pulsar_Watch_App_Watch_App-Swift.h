...
#ifndef PULSAR_WATCH_APP_WATCH_APP_SWIFT_H
#define PULSAR_WATCH_APP_WATCH_APP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Pulsar_Watch_App_Watch_App",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC26Pulsar_Watch_App_Watch_App32PulsarWatchConnectivitySyncStore")
@interface PulsarWatchConnectivitySyncStore : NSObject
...
@class WCSession;
@class NSString;
@interface PulsarWatchConnectivitySyncStore (SWIFT_EXTENSION(Pulsar_Watch_App_Watch_App)) <WCSessionDelegate>
...
SWIFT_CLASS("_TtC26Pulsar_Watch_App_Watch_App22WatchGymSessionManager")
@interface WatchGymSessionManager : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@class HKSampleType;
@interface WatchGymSessionManager (SWIFT_EXTENSION(Pulsar_Watch_App_Watch_App)) <HKLiveWorkoutBuilderDelegate>
...
@class NSDate;
@interface WatchGymSessionManager (SWIFT_EXTENSION(Pulsar_Watch_App_Watch_App)) <HKWorkoutSessionDelegate>
...
SWIFT_CLASS("_TtC26Pulsar_Watch_App_Watch_App19WatchRunAppDelegate")
@interface WatchRunAppDelegate : NSObject <WKApplicationDelegate>
- (void)handleWorkoutConfiguration:(HKWorkoutConfiguration * _Nonnull)workoutConfiguration;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC26Pulsar_Watch_App_Watch_App22WatchRunSessionManager")
@interface WatchRunSessionManager : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@class CLLocation;
@interface WatchRunSessionManager (SWIFT_EXTENSION(Pulsar_Watch_App_Watch_App)) <CLLocationManagerDelegate>
- (void)locationManager:(CLLocationManager * _Nonnull)manager didUpdateLocations:(NSArray<CLLocation *> * _Nonnull)locations;
@end

@interface WatchRunSessionManager (SWIFT_EXTENSION(Pulsar_Watch_App_Watch_App)) <HKLiveWorkoutBuilderDelegate>
- (void)workoutBuilder:(HKLiveWorkoutBuilder * _Nonnull)workoutBuilder didCollectDataOfTypes:(NSSet<HKSampleType *> * _Nonnull)collectedTypes;
- (void)workoutBuilderDidCollectEvent:(HKLiveWorkoutBuilder * _Nonnull)workoutBuilder;
@end

@class NSData;
@interface WatchRunSessionManager (SWIFT_EXTENSION(Pulsar_Watch_App_Watch_App)) <HKWorkoutSessionDelegate>
- (void)workoutSession:(HKWorkoutSession * _Nonnull)workoutSession didChangeToState:(HKWorkoutSessionState)toState fromState:(HKWorkoutSessionState)fromState date:(NSDate * _Nonnull)date;
- (void)workoutSession:(HKWorkoutSession * _Nonnull)workoutSession didFailWithError:(NSError * _Nonnull)error;
- (void)workoutSession:(HKWorkoutSession * _Nonnull)workoutSession didReceiveDataFromRemoteWorkoutSession:(NSArray<NSData *> * _Nonnull)data;
@end
