...
SWIFT_CLASS("_TtC6Pulsar26GymHealthKitWorkoutManager")
@interface GymHealthKitWorkoutManager : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class HKLiveWorkoutBuilder;
@class HKSampleType;
@interface GymHealthKitWorkoutManager (SWIFT_EXTENSION(Pulsar)) <HKLiveWorkoutBuilderDelegate>
...
@class NSDate;
@interface GymHealthKitWorkoutManager (SWIFT_EXTENSION(Pulsar)) <HKWorkoutSessionDelegate>
...
SWIFT_CLASS("_TtC6Pulsar20PulsarRunCoordinator")
@interface PulsarRunCoordinator : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class CLLocationManager;
@class CLLocation;
@interface PulsarRunCoordinator (SWIFT_EXTENSION(Pulsar)) <CLLocationManagerDelegate>
- (void)locationManager:(CLLocationManager * _Nonnull)manager didUpdateLocations:(NSArray<CLLocation *> * _Nonnull)locations;
- (void)locationManagerDidChangeAuthorization:(CLLocationManager * _Nonnull)manager;
@end

@interface PulsarRunCoordinator (SWIFT_EXTENSION(Pulsar)) <HKLiveWorkoutBuilderDelegate>
- (void)workoutBuilder:(HKLiveWorkoutBuilder * _Nonnull)workoutBuilder didCollectDataOfTypes:(NSSet<HKSampleType *> * _Nonnull)collectedTypes;
- (void)workoutBuilderDidCollectEvent:(HKLiveWorkoutBuilder * _Nonnull)workoutBuilder;
@end

@class NSData;
@interface PulsarRunCoordinator (SWIFT_EXTENSION(Pulsar)) <HKWorkoutSessionDelegate>
- (void)workoutSession:(HKWorkoutSession * _Nonnull)workoutSession didChangeToState:(HKWorkoutSessionState)toState fromState:(HKWorkoutSessionState)fromState date:(NSDate * _Nonnull)date;
- (void)workoutSession:(HKWorkoutSession * _Nonnull)workoutSession didFailWithError:(NSError * _Nonnull)error;
...
- (void)workoutSession:(HKWorkoutSession * _Nonnull)workoutSession didDisconnectFromRemoteDeviceWithError:(NSError * _Nullable)error;
@end

SWIFT_CLASS("_TtC6Pulsar32PulsarWatchConnectivitySyncStore")
...
@class WCSession;
@class NSString;
@interface PulsarWatchConnectivitySyncStore (SWIFT_EXTENSION(Pulsar)) <WCSessionDelegate>
