...
static NSString * const ACImageNameAmazfitHelioRingDevice AC_SWIFT_PRIVATE = @"AmazfitHelioRingDevice";

/// The "AppleWatchDevice" asset catalog image resource.
static NSString * const ACImageNameAppleWatchDevice AC_SWIFT_PRIVATE = @"AppleWatchDevice";
...
static NSString * const ACImageNamePulsarLogoRed AC_SWIFT_PRIVATE = @"PulsarLogoRed";
